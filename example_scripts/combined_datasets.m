...
[rap_score, rap_details] = detection_performance(rap_val_path, rap_predictions);
...
[dd_score, dd_details] = detection_performance(dd_val_path, dd_predictions);
...
[wrap_score, wrap_details] = detection_performance(wrap_val_path, wrap_predictions);